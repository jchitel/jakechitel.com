    ...
    <Section anchor="about" header="About Me">
        <Box className="space-y-4">
            ...
            <Paragraph>
                ...
                It's a long term goal of mine to build a compiler for a language
                of my very own.
            </Paragraph>
            <Paragraph>
                I was extremely fortunate to get a development job at
                Marquette's GasDay Lab when I was just a freshman. It was here
                that I gained valuable experience on the job as an actual
            ...
            <Paragraph>
                ...
                my roots back in Milwaukee. Since returning home, I've had some
                wonderful experiences, most notably at Direct Supply, where I
                had the opportunity to rebuild a native mobile app from the
                ground up.
            </Paragraph>
            <Paragraph>
                Today, I'm working remote full-time at Ventus Risk, where I'm
                hoping to get some valuable experience with Python and continue
                advancing my React skills. Stay tuned for more developments
                here!
            </Paragraph>
        </Box>
    </Section>
