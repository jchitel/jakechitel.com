    ...
    <Section anchor="about" header="About Me">
        <Box className="space-y-4">
            ...
            <Paragraph>
                ...
                for a language of my very own.
            </Paragraph>
            <Paragraph>
                I was extremely fortunate to get a development job at Marquette's GasDay Lab when I was just
                a freshman. It was here that I gained valuable experience on the job as an actual developer,
                including unit testing, agile development, and version control. This experience helped me to gain two
                internships during my undergrad, the latter at Amazon in Seattle, which scored me a full-time gig
                there after graduating.
            </Paragraph>
            <Paragraph>
                It was at Amazon that I gained a passion for frontend web development, working on the AWS Lambda
                Console. After a year there, I discovered that living 2000 miles from my family was not my cup of tea,
                so I said farewell to Seattle and returned to my roots back in Milwaukee. Since returning home,
                I've had some wonderful experiences, most notably at Direct Supply, where I had the opportunity
...
export const Education = () => (
    <Section header="Education">
        <Box>
            <p className="font-bold">Marquette University - Milwaukee, Wisconsin</p>
